...
extern void js_gl_clear_depth(f8 d);
extern void js_gl_clear_stencil(s4 s);
...
extern void js_gl_blend_func(s4 src, s4 dst);
extern void js_gl_depth_func(s4 func);
extern void js_gl_depth_mask(s4 flag);
extern void js_gl_color_mask(s4 r, s4 g, s4 b, s4 a);
extern void js_gl_cull_face(s4 mode);
extern void js_gl_front_face(s4 mode);
extern void js_gl_shade_model(s4 mode);
extern void js_gl_polygon_offset(f4 factor, f4 units);
extern void js_gl_line_width(f4 w);
extern void js_gl_point_size(f4 s);
extern void js_gl_alpha_func(s4 func, f4 ref);
extern void js_gl_active_texture(s4 tex);
...
extern void js_gl_tex_parameteri(s4 target, s4 pname, s4 param);
extern void js_gl_tex_parameterf(s4 target, s4 pname, s4 param);
extern void js_gl_tex_image_2d(s4 target, s4 level, s4 internal, s4 w, s4 h, s4 border, s4 format, s4 type, void *pixels);
extern void js_gl_tex_sub_image_2d(s4 target, s4 level, s4 xoff, s4 yoff, s4 w, s4 h, s4 format, s4 type, void *pixels);
extern void js_gl_copy_tex_sub_image_2d(s4 target, s4 level, s4 xoff, s4 yoff, s4 x, s4 y, s4 w, s4 h);
extern void js_gl_generate_mipmap(s4 target);
extern void js_gl_pixel_storei(s4 pname, s4 param);
...
extern s4 js_gl_create_shader(s4 type);
...
extern s4 js_gl_get_uniform_location(s4 prog, const char *name);
extern s4 js_gl_get_attrib_location(s4 prog, const char *name);
extern void js_gl_uniform1i(s4 loc, s4 v);
extern void js_gl_uniform1f(s4 loc, f4 v);
extern void js_gl_uniform2f(s4 loc, f4 x, f4 y);
extern void js_gl_uniform3f(s4 loc, f4 x, f4 y, f4 z);
extern void js_gl_uniform4f(s4 loc, f4 x, f4 y, f4 z, f4 w);
...
extern void js_gl_buffer_data(s4 target, s8 size, void *data, s4 usage);
extern void js_gl_buffer_sub_data(s4 target, s8 offset, s8 size, void *data);
...
extern void js_gl_begin(s4 mode);
extern void js_gl_end(void);
extern void js_gl_vertex2f(f4 x, f4 y);
extern void js_gl_vertex3f(f4 x, f4 y, f4 z);
extern void js_gl_vertex2fv(void *ptr);
extern void js_gl_vertex3fv(void *ptr);
...
extern void js_gl_color3ub(s4 r, s4 g, s4 b);
extern void js_gl_color4ub(s4 r, s4 g, s4 b, s4 a);
extern void js_gl_normal3f(f4 x, f4 y, f4 z);

extern void js_gl_matrix_mode(s4 mode);
...
extern void js_gl_frustum(f8 l, f8 r, f8 b, f8 t, f8 n, f8 f);

extern void js_gl_get_floatv(s4 pname, void *ptr);
extern void js_gl_get_integerv(s4 pname, void *ptr);
extern void js_gl_get_string(s4 name, void *ptr);
extern s4 js_gl_get_error(void);

extern void js_gl_new_list(s4 list, s4 mode);
extern void js_gl_end_list(void);
extern void js_gl_call_list(s4 list);
extern void js_gl_delete_lists(s4 list, s4 range);
extern s4 js_gl_gen_lists(s4 range);
extern s4 js_gl_is_list(s4 list);

extern void js_gl_read_pixels(s4 x, s4 y, s4 w, s4 h, s4 format, s4 type, void *pixels);
extern void js_gl_read_buffer(s4 mode);
extern void js_gl_bind_framebuffer(s4 target, s4 fb);
extern void js_gl_gen_framebuffers(s4 n, void *ptr);
extern void js_gl_delete_framebuffers(s4 n, void *ptr);
extern void js_gl_framebuffer_texture2d(s4 target, s4 att, s4 textarget, s4 tex, s4 level);
extern s4 js_gl_check_framebuffer_status(s4 target);

extern void js_fogf(s4 pname, f4 val);
extern void js_fogi(s4 pname, s4 val);
extern void js_fogfv(s4 pname, void *ptr);
...
extern s4 js_get_mouse_dx(void);
extern s4 js_get_mouse_dy(void);
extern s4 js_get_mouse_dwheel(void);
...
extern s4 js_audio_init(void);
extern void js_audio_play(s4 source, f4 vol);
extern void js_audio_stop(s4 source);
extern void js_audio_set_volume(s4 source, f4 vol);
extern void js_audio_al_gen_sources(s4 n, void *ptr);
extern void js_audio_al_delete_sources(s4 n, void *ptr);
extern void js_audio_al_gen_buffers(s4 n, void *ptr);
extern void js_audio_al_buffer_data(s4 buf, s4 fmt, void *data, s4 size, s4 freq);
extern void js_audio_al_source_play(s4 src);
extern void js_audio_al_source_stop(s4 src);
extern void js_audio_al_sourcef(s4 src, s4 param, f4 val);
extern s4 js_audio_al_get_error(void);
...
extern s4 js_socket_available(void);
